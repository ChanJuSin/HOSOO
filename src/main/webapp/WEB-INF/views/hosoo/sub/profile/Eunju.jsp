	        ...
	        <div class="content_bak">
	            <div class="content_width">
	                <div class="txt">
	                    ...
	                    <h2 class="color3">PARK EUNJU</h2>
	                    <p>안녕하세요 저는 HOSOO에서 웹 퍼블리싱을 담당한<br /> Fox 캐릭터의 Web Publisher 박은주 입니다.</p>
	                </div>
	                <img src="${resources }images/char/ej.png" alt="woonayeong" />
	            </div>
	        </div>
	    </div>
	        ...
	        <div class="cont_bak">
	            <div class="cont_width">
	                ...
	                <div class="left">
	                    ...
	                    <a href="#1" onclick="mailSend()" class="bg_3"><button>SUBMIT</button></a>
	                </div>
	                <div class="right">
	                    <h5>TELLPHONE</h5>
	                    <p>+82(010 - 2576 - 3402)</p>
	                    <h5>E-MAIL</h5>
	                    <p id="profile_email">dlffldkem1&#64;naver.com</p>
	                    <h5>HOME</h5>
	                    <p>Osan, Gyeonggi</p>
	                </div>
	            </div>
