	        ...
	        <div class="content_bak">
	            <div class="content_width">
	                <div class="txt">
	                    ...
	                    <h2 class="color2">LEE NAGYEONG</h2>
	                    <p>안녕하세요 저는 HOSOO에서 웹디자인을 담당한<br /> Dog 캐릭터의 Web Designer 이나경 입니다.</p>
	                </div>
	                <img src="${resources }images/char/ng.png" alt="woonayeong" />
	            </div>
	        </div>
	    </div>
	        ...
	        <div class="cont_bak">
	            <div class="cont_width">
	                ...
	                <div class="left">
	                    ...
	                    <a href="#1" onclick="mailSend()" class="bg_2"><button>SUBMIT</button></a>
	                </div>
	                <div class="right">
	                    <h5>TELLPHONE</h5>
	                    <p>+82(010 - 7733 - 7539)</p>
	                    <h5>E-MAIL</h5>
	                    <p id="profile_email">nana8852&#64;naver.com</p>
	                    <h5>HOME</h5>
	                    <p>Hwasung, Gyeonggi</p>
	                </div>
	            </div>
	        </div>
	    </div>
