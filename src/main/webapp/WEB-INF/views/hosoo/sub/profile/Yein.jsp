	        ...
	        <div class="content_bak">
	            <div class="content_width">
	                <div class="txt">
	                    ...
	                    <h2 class="color6">LEE YEIN</h2>
	                    <p>안녕하세요 저는 HOSOO에서 개발을 담당한<br /> Rabbit 캐릭터의 Web Developer 이예인 입니다.</p>
	                </div>
	                <img src="${resources }images/char/yi.png" alt="woonayeong" />
	            </div>
	        </div>
	    </div>
	        ...
	        <div class="cont_bak">
	            <div class="cont_width">
	                ...
	                <div class="left">
	                    ...
	                    <a href="#1" onclick="mailSend()" class="bg_6"><button>SUBMIT</button></a>
	                </div>
	                <div class="right">
	                    <h5>TELLPHONE</h5>
	                    <p>+82(010 - 8929 - 0223)</p>
	                    <h5>E-MAIL</h5>
	                    <p id="profile_email">yein2656&#64;daum.net</p>
	                    <h5>HOME</h5>
