	        ...
	        <div class="content_bak">
	            <div class="content_width">
	                <div class="txt">
	                    ...
	                    <h2 class="color5">SIN CHANJU</h2>
	                    <p>안녕하세요 저는 HOSOO에서 개발을 담당한<br /> Eagle 캐릭터의 Web Developer 신찬주 입니다.</p>
	                </div>
	                <img src="${resources }images/char/cj.png" alt="woonayeong" />
	            </div>
	        </div>
	    </div>
	        ...
	        <div class="cont_bak">
	            <div class="cont_width">
	                ...
	                <div class="left">
	                    ...
	                    <a href="#1" onclick="mailSend()" class="bg_5"><button>SUBMIT</button></a>
	                </div>
	                <div class="right">
	                    <h5>TELLPHONE</h5>
	                    <p>+82(010 - 8792 - 0660)</p>
	                    <h5>E-MAIL</h5>
	                    <p id="profile_email">ckswn1259&#64;naver.com</p>
	                    <h5>HOME</h5>
	                    <p>Suwon, Gyeonggi</p>
	                </div>
	            </div>
